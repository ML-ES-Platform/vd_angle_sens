...
#ifndef _VD_ANGLE_SENS_CFG_H_
#define _VD_ANGLE_SENS_CFG_H_
...
enum VD_ANGLE_SENS_Cnl_IdType {ANGSNS_1,ANGSNS_2, ANGSNS_3, VD_ANGLE_SENS_CHANNEL_NR_OF};
#endif

#endif /* _VD_ANGLE_SENS_CFG_H_ */
